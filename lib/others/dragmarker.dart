...
class DragMarkerPlugin implements MapPlugin {
  ...
  @override
  Widget createLayer(
      LayerOptions options, MapState mapState, stream) {
...
class _DragMarkerWidgetState extends State<DragMarkerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onPanStart:  marker.draggable? onPanStart : null,
      onPanUpdate: marker.draggable? onPanUpdate : null,
      onPanEnd:    marker.draggable? onPanEnd : null,
      onTap:       () { 
      ...
      onLongPress: () { 
        if (marker.onLongPress != null) {
          //Long Press to show the current location
  ...
  void onPanEnd(details) {
    ...
    {
      //This will be execute when drag end
